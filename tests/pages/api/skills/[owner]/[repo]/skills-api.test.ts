...
describe('GET /api/skills/[owner]/[repo] (index.ts)', () => {
  ...
  beforeEach(async () => {
    ...
    const mod = await import('../../../../../../src/pages/api/skills/[owner]/[repo]/index');
    GET = mod.GET;
  });
  ...
  it('strips source-like fields from public detail payloads and returns noindex headers', async () => {
    const originalFetch = globalThis.fetch;
    const skillContent = `---
name: Test Skill
description: A test skill
...
Install this skill and run it in your workflow.
`;
        ...
        new Map([
          [
            ...
            JSON.stringify({
              ...
              repo: 'test-repo',
              description: 'A test skill',
              filePath: '.claude/skills/test-repo/SKILL.md',
            }),
          ],
        ]),
      ),
    ...
    const ctx = createAPIContext({
      params: { owner: 'test-owner', repo: 'test-repo' },
      url: 'http://localhost/api/skills/test-owner/test-repo?path=.claude/skills/test-repo',
      env,
    });
    ...
    expect(body.skillPath).toBeUndefined();
    expect(body.rawSkillMd).toBeUndefined();
    expect(body.skillMd.body).toBeUndefined();
    expect(body.skillMd.bodyPreview).toContain('Install this skill');
...
describe('GET /api/skills/[owner]/[repo]/files (files.ts)', () => {
  ...
  beforeEach(async () => {
    vi.restoreAllMocks();
    const mod = await import('../../../../../../src/pages/api/skills/[owner]/[repo]/files');
    GET = mod.GET;
  });
...
describe('GET /api/skills/[owner]/[repo]/file (file.ts)', () => {
  ...
  beforeEach(async () => {
    vi.restoreAllMocks();
    const mod = await import('../../../../../../src/pages/api/skills/[owner]/[repo]/file');
    GET = mod.GET;
  });
