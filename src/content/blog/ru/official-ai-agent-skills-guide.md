...
> - **Нулевая настройка**: Все официальные навыки устанавливаются глобально через `npx killer-skills add owner/repo`.
...
Готовы попробовать? Вы можете установить любую из этих функций прямо сейчас, выполнив команду `npx killer-skills add owner/repo` в вашем терминале.
