...
> - **Универсальная совместимость**: Установите навыки в 19+ IDE по всему миру, используя `npx killer-skills add owner/repo`.
...
Мы ведём каталог из более чем 2,500 навыков для агентов и ежедневно используем десятки из них. Некоторые — превосходны. Многие — посредственны. Некоторые изменили наш способ работы.
...
Ознакомьтесь с полной коллекцией на сайте [killer-skills.com/ru/skills](/ru/skills).
...
Эти навыки совместимы с 19+ основными средами разработки с поддержкой ИИ, включая Cursor, Windsurf, VS Code (через Copilot или Cline), Trae и Claude Code CLI.
