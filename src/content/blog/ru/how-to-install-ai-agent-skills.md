...
Вы нашли навык AI-агента, который хотите использовать. Возможно, это [навык автоматизации docx](/ru/skills/anthropics/skills/docx), или, может быть, специализированный генератор интерфейса для фронтенда. Теперь вам нужно добавить его в свой проект, чтобы ваш кодирующий агент мог его прочитать.
...
_Связано: [Что такое навыки агента ИИ?](/ru/blog/what-are-ai-agent-skills) и [Лучшие навыки агента ИИ для 2026 года](/ru/blog/best-ai-agent-skills-2026)_
