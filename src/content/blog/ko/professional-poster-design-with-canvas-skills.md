...
제너릭 카나바 템플릿으로 가득 찬 세상에서, 진정한 디자인은 **의도성**을 통해 돋보입니다. 전문적인 디자인은 로고를 어디에 놓느냐가 아니라, 모든 픽셀을 지휘하는 형태, 공간, 색채의 철학에 관한 것입니다.

Anthropic의 공식 **canvas-design** 스킬은 AI 에이전트가 레이아웃을 넘어서 고급 시각 예술의 영역으로 나아갈 수 있도록 합니다. 브루탈리스틱 이벤트 포스터, 미니멀리스트 브랜드 아이덴티티, 또는 고급 PDF 리포트가 필요한 경우에 이 스킬은 아티즌과 전문적인 출력을 보장합니다.
...
지금 바로 Killer-Skills 디렉터리에서 [canvas-design 스킬](https://killer-skills.com/en/skills/anthropics/skills/canvas-design)을 확인하고 다운로드해 디자인을 시작해 보세요.

---

_더 찾고 계신가요? 코드 기반 생성 예술은 [algorithmic-art](https://killer-skills.com/en/skills/anthropics/skills/algorithmic-art)를 확인해 보세요._
