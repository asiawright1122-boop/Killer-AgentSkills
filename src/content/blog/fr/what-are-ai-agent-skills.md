...
*Related: [How to build MCP servers with agent skills](/fr/blog/how-to-build-mcp-servers-with-agent-skills) and [Create your own custom AI agent skills](/fr/blog/create-custom-ai-agent-skills)*
