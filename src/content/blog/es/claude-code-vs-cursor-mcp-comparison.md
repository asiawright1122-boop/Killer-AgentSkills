...
2. **Experiencia durante la sesión**: si el uso de herramientas, recursos y prompts resulta claro o requiere demasiados pasos manuales.
3. **Depuración y observabilidad**: qué tan fácil es detectar errores de conexión, permisos o formato.
4. **Rendimiento percibido**: latencia, estabilidad y consistencia al invocar herramientas repetidamente.
...
- ejecutar comandos y validar resultados dentro del mismo flujo;
- trabajar con instrucciones operativas claras para tareas de implementación, revisión o diagnóstico;
- mantener contexto técnico consistente al combinar código, terminal y servidores MCP.
...
- hacer cambios rápidos dentro del IDE;
- apoyarse en una experiencia más visual para navegar archivos y sugerencias;
- reducir el cambio de contexto para tareas pequeñas de edición.
...
- invocar varias herramientas seguidas;
- revisar cómo se presentan los errores;
- medir si el flujo exige pasos manuales adicionales;
- comprobar cómo se gestionan credenciales y configuración compartida.
