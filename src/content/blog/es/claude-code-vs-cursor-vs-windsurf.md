...
We publish all skills on [Killer-Skills](https://killer-skills.com/es/skills) in Claude Code format, and the CLI can install them for other agents with flag adjustments.
