...
description: 'Descubre las habilidades de los agentes IA—archivos SKILL.md reutilizables que instruyen a agentes de codificación como Claude Code, Cursor y Windsurf para seguir las convenciones de tu proyecto con soporte de Model Context Protocol (MCP).'
pubDate: 2026-02-23
...
_Relacionado: [Cómo construir servidores MCP con habilidades de agente](/es/blog/how-to-build-mcp-servers-with-agent-skills) y [Crea tus propias habilidades personalizadas para agentes de IA](/es/blog/create-custom-ai-agent-skills)_
