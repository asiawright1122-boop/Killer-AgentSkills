...
Every time you refactor a [frontend-design](https://killer-skills.com/zh/skills/anthropics/skills/frontend-design) component, have the agent run a `webapp-testing` script to ensure that buttons still click and forms still submit.
...
Head over to the [Killer-Skills Marketplace](https://killer-skills.com/zh/skills/anthropics/skills/webapp-testing) and start building bulletproof frontends today.

---

*Want to build the UI first? Check out the [frontend-design skill](https://killer-skills.com/zh/skills/anthropics/skills/frontend-design).*
