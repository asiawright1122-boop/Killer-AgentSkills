...
今天，我们激动地宣布 **Killer-Skills** 正式上线 —— 这是首个面向 AI 智能体能力的开放技能目录和注册中心。
## 当今 AI 代理存在的问题
...
-   **通用注册表**：通过单一命令即可访问超过 2,500 个经过验证的技能。
...
Killer-Skills 是一个社区驱动的项目。探索文档，浏览[技能目录](https://killer-skills.com/zh/skills)，并通过创建自己的技能开始贡献。
