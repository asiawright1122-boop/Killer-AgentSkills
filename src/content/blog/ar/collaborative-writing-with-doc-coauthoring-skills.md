...
- **أسئلة توضيحية**: يطرح الوكيل 5-10 أسئلة محددة لإغلاق "فجوة المعرفة" ، وضمان فهمه _السبب_ وراء المشروع ، وليس فقط _الماهية_.

### المرحلة 2: تحسين الهيكل

مرة واحدة يتم جمع السياق ، يقوم الوكيل ببناء الوثيقة قسمًا قسمًا:

- **العصف الذهني**: لكل قسم، يقدم الوكيل 5-20 خيارًا أو زاوية للتغطية.
...
اطلب من الوكيل "اختبار القارئ" للمواصفات الفنية الخاصة بك لمعرفة ما إذا كان يمكن لمطوّر تنفيذ الميزة بالاعتماد _فقط_ على النص المقدم.
...
زر [مهارة doc-coauthoring](https://killer-skills.com/en/skills/anthropics/skills/doc-coauthoring) في دليل مهارات Killer-Skills وابدأ كتابة مستندات تعمل فعلاً.

---

- تحتاج إلى تحديد التنسيق النهائي؟ ادمج هذا مع مهارة [docx](https://killer-skills.com/en/skills/anthropics/skills/docx) للحصول على تصديرprofessionel من Word.

---

_متعلق: [ما هي مهارات الوكيل الذكي؟](/ar/blog/what-are-ai-agent-skills) و [أفضل مهارات الوكيل الذكي لعام 2026](/ar/blog/best-ai-agent-skills-2026)_
