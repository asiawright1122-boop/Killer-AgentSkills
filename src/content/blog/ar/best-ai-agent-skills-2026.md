...
> - **التوافق العالمي**: ثبّت المهارات عبر 19+ بيئة تطوير متكاملة (IDE) حول العالم باستخدام `npx killer-skills add owner/repo`.
...
نحن نحتفظ بدليل يضم أكثر من 2,500 مهارة للوكلاء ونستخدم العشرات منها يوميًا. بعضها ممتاز. والكثير منها متوسط. وقد غير القليل منها طريقة عملنا.
...
تصفح المجموعة الكاملة في [killer-skills.com/ar/skills](/ar/skills).
## الأسئلة الشائعة
...
هذه المهارات متوافقة مع 19+ بيئة برمجة رئيسية تعمل بالذكاء الاصطناعي، بما في ذلك Cursor وWindsurf وVS Code (عبر Copilot أو Cline) وTrae وClaude Code CLI.
