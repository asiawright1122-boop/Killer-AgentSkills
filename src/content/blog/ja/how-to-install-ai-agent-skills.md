...
description: 'AIエージェントスキルを30秒でインストールする方法：killer-skills CLIツールを使用してClaude Codeにスキルを追加する方法を'
pubDate: 2026-02-24
...
あなたは使用したいAIエージェントのスキルを見つけた。たぶんそれは、[docx自動化スキル](/ja/skills/anthropics/skills/docx)か、特殊なフロントエンドUIジェネレーターである。ここで、あなたはそれをプロジェクトに組み込む必要があるので、コーディングエージェントが実際にそれを読むことができるようになる。
