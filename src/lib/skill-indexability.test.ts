...
describe('skill-indexability', () => {
  ...
  it('keeps a well-supported skill indexable once it clears the long-tail quality floor', () => {
    const assessment = buildSkillIndexabilityAssessment(
      {
        qualityScore: 35,
        verified: false,
  ...
  it('drops to reference-only when quality floor is still below the review threshold', () => {
    const assessment = buildSkillIndexabilityAssessment(
      {
        qualityScore: 34,
        agentAnalysis: {
