...
// Indexability report is loaded via import so path resolution works in both
// dev mode and prerender builds (where process.cwd() is '/').
// The report is generated by `scripts/seo-skill-indexability-report.ts`.
...
const skillIndexabilityRecords = (
  ...
  (skillIndexabilityReportData as { skills: unknown[] }).skills.length > 0
