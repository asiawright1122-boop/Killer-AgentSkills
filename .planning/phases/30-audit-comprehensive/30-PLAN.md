...
files_modified:
  - ".planning/ROADMAP.md"
  - ".planning/STATE.md"
  - ".planning/phases/30-audit-comprehensive/30-PLAN.md"
  - ".planning/phases/30-audit-comprehensive/30-01-SUMMARY.md"
autonomous: true
requirements:
  - AUDIT-COMP-01
must_haves:
  ...
  artifacts:
    - path: ".planning/phases/30-audit-comprehensive/30-01-SUMMARY.md"
...
@.planning/ROADMAP.md
@.planning/STATE.md
@.planning/phases/02-re-enrichment-pipeline-run
@.planning/phases/29-automation-audit
@.planning/phases/audit-comprehensive/AUDIT.md
...
<output>
After completion, create `.planning/phases/30-audit-comprehensive/30-01-SUMMARY.md`
</output>
