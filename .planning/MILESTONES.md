...
---
### v3.8 Backlog Content Enrichment Automation (Shipped: 2026-06-09)
...
---
### v3.7 v3.7 (Shipped: SHIPPED)

**Delivered:** `v3.7 Authority Expansion & Content Depth Acceleration` is now the active milestone.
...
- Formalized a guarded recovery experiment ladder that keeps automation locked until manual wins prove repeatable.
...
---
### v1.5 Traffic Recovery Proof and Demand Restart (Shipped: 2026-04-16)
...
- Reduced the governed public skill publish set from `2950` routes to `1099` kept routes while keeping keep / noindex / consolidate / remove outcomes auditable.
...
**What's next:** **UX-EXP-01**: Reopen public discovery expansion only after traffic proof, governance rollout, and authority-surface recovery stay inside guardrails.

---
### v1.4 Traffic Recovery Closure (Shipped: 2026-04-09)
...
- Rebuilt the planning traceability and milestone support chain so `v1.4` could be audited and closed cleanly.
...
**What's next:** **SEO-14**: Fresh Search Console summary and page/query opportunity data should be available weekly without manual export hunting.

---
### v1.3 Adaptive Provider Control and Escalation Automation (Shipped: 2026-04-07)
...
- Automated phase archive lifecycle so active discovery is reduced to the current milestone only and shipped phase directories live under milestone-specific archive roots.
...
**What's next:** **AIOPS-11**: Promote workload-aware provider policy into operator-managed profiles with environment-specific defaults.

---
### v1.2 Operator Automation and Runtime Convergence (Shipped: 2026-04-07)
...
- Extended planning traceability into milestone bootstrap and closeout support generation.
...
**What's next:** **AIOPS-08**: Introduce operator-approved adaptive provider weighting by workload class, not just global history.

---
### v1.1 Observability and Governance Hardening (Shipped: 2026-04-06)
...
- Consolidated locale, metadata, breadcrumb, tutorial-shell, and collection drift checks into one governance lane.
...
**What's next:** **AIOPS-05**: Provider selection can self-tune based on longer-window success rates without hiding operator control.

---
### v1.0 Reliability and Growth Operations (Shipped: 2026-04-06)
...
- Preserved unattended pipeline confidence with production smoke checks and automation audit evidence.
