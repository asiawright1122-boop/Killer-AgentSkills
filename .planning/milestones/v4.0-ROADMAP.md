...
`v4.0 Authority Proof Remediation & Public Trust Hardening` is now the active milestone.

This milestone turns the v3.9 proof-refresh findings into a user-facing remediation loop: strengthen the five focus authority surfaces with visible first-party proof, selection logic, and install handoffs while keeping recovery/control-board language and internal reasoning out of public frontend copy.

## Immediate Next Actions

- Plan and execute Phase 123: Trusted and Workflow Collection Proof Upgrade.
- Keep discovery expansion closed until a future proof window clears the `2` primary promote-surface gate.
- Treat public hidden-reasoning and operator-language leakage as release blockers during all v4.0 copy work.
...
- **Requirements:** AIOPS-43
- **Scope:** Rewrite the homepage authority section so it explains selection criteria, curated entry paths, and trusted next steps in user-facing language rather than recovery or directory-volume language.
- **Status:** Complete
- **Plans:** 1/1 complete
...
- 🔄 **v4.0 Authority Proof Remediation & Public Trust Hardening** — phases 122-125 (active)
...
| ---------------------------------------------------------------- | ------- | ----- | -------- | ---------- |
| v4.0 Authority Proof Remediation & Public Trust Hardening        | 122-125 | 1/4   | Active   | -          |
