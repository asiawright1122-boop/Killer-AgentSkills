...
`v2.7 Operator Profiles and Fresh Ingestion` shipped on `2026-06-03` and is now archived.

This milestone focuses on establishing Operator-Managed Profiles for flexible provider settings and updating GSC Coverage input freshness.

## Immediate Next Actions

- None. Milestone v2.7 complete.
...
Plans:
- [x] `80-01`: Setup provider profiles and execute Coverage ingestion.
