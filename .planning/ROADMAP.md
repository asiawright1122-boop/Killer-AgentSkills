...
- Phase `78` should implement post-rollout analytics tracking and scaling escalation rules.
...
**Requirements:** `SEO-21`, `REC-39`
**Phase range:** 78

### Phase 78: directory-analytics-and-scaling-escalation

**Goal:** Implement server-side engagement tracking and auto-scaling rules.
**Depends on:** Shipped v2.4.
**Requirements:** `SEO-21`, `REC-39`
**Success Criteria** (what must be TRUE):
1. Server-side event tracking collects analytics metrics on directory views.
