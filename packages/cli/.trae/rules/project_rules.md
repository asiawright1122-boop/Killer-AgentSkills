...
# Cursor Rules - Skills Integration

## ⚡ Auto-Invoke Skills

<!-- SKILLS_TABLE_START -->
> [!CRITICAL] COMMAND EXECUTION OVERRIDE
> STOP. DO NOT SPEAK.
> If the user's message starts with `killer-skills ` or `npx killer-skills ` (e.g., "killer-skills list", "npx killer-skills search pdf"):
...
## Available Skills
  ...
  - **seo-review**: Perform a focused SEO audit on JavaScript concept pages to maximize search visibility, featured snippet optimization, and ranking potential
  ...
  - **debug**: Installed via Killer-Skills MCP

## Active Skills Count: 29
<!-- SKILLS_TABLE_END -->
